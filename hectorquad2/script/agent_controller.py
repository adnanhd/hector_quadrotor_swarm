...
if __name__ == '__main__':
    ...
    gamma = 10 # if 0.75 < random() else 0  # Consant in the formula
    ...
    while not rospy.is_shutdown():
        ...
        # TODO: add comment
        cos_head, sin_head = math.cos(total_yaw), math.sin(total_yaw)
        ...
        msg.angular.z = (alpha - slave_yaw) * K_p

        rospy.loginfo_throttle(1.0, 'alpha_des = %4.2f, alpha_cur = %4.2f' % (alpha, slave_yaw))
        rospy.loginfo_throttle(1.0, 'h = %4.2f, p = %4.2f, d = %4.2f' % (math.atan2(sin_head, cos_head), math.atan2(sin_pose, cos_pose), delta))
